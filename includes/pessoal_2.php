		...
		<div class='panel-body'>
			<div class='row'>
				...
				<div class='col-md-3'>
					...
					<input class='form-control' type='text' value='<?php echo $row->NUM_FUNCIONARIO?>' id='num_func' name='NUM_FUNCIONARIO' required>
				</div>
				<div class='col-md-3'>
					<strong>CGA</strong>
					<input class='form-control' value='<?php echo utf8_encode($row->CGA)?>' id='cga' name='CGA' >
				</div>
			</div>
			<!-- Nova Linha -->
			...
			<div class='row margin-row'>
				...
				<div class='col-md-3'>
					...
					<input class='form-control' type='text' maxlength='9' id='tel' value='<?php echo utf8_encode($row->TEL)?>' name='TEL' >
				</div>
				<!-- Nº TELEMOVEL -->
				<div class='col-md-3'>
					<strong>Telemóvel*</strong>
					<input class='form-control' type='text' maxlength='9' id='tlm' value='<?php echo utf8_encode($row->TLM)?>' name='TLM' required>
				</div>
				<!-- EMAIL -->
				<div class='col-md-6'>
					<strong>Email*</strong>
			...
			<div class='row margin-row'>
				...
				<div class='col-md-5'>
					...
					<input class='form-control' type='text' name='ESCOLA' id='outra_escola_campo' placeholder='Para indicar outra escola seleccione a opção \"OUTRA ESCOLA\"' value='<?php echo utf8_encode($row->ESCOLA_TITULAR)?>' >
				</div>
			</div>
		</div>
