	...
	function enviar_mail(){
		...
		$message = '<html><body>';
			...
			$message .= '<p style="line-height: 190%">';
				...
				$message .= '<b>C�digo Postal: </b>' . $row->COD_POSTAL."-".$row->IND_CODPOSTAL . '<br>';
				...
				while ($row2 = mysql_fetch_object($res2)){
					if($row2->ID_MUNICIPIO == $row->ID_MUNICIPIO){
						$message .= '<b>Munic�pio: </b>' . $row2->MUNICIPIO . '<br>';
					}
				}
				...
				$message .= '<b>In�cio de Fun��es: </b>' . $INICIO_FUNCOES . '<br>';
				...
				$message .= '<b>N� Identifica��o Civil: </b>' . $row->BI . '<br>';
				...
				$message .= '<b>N� dependentes: </b>' . $row->NUM_DEPENDENTES . '<br>';
			$message .= '</p>';
			...
			if($num>0){
				...
				while($row = mysql_fetch_object($res)){
					...
					if($num>0){
						$message .='<br><b>PR�-ESCOLAR:</b><div class="table-responsive">
						...
						$message .= '
							<br><b>PR�-ESCOLAR:</b><p>N�o foram enviados dados sobre o pr�-escolar.</p>
						';
					}
					...
					if($num>0){
						...
						$message .= '
							...
							<p>N�o foram enviados dados sobre o primeiro ciclo.</p>
						';
					}
					$message .= '<hr>';
				}
