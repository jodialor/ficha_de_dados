				...
				while($row = mysql_fetch_object($res)){
					echo"<tr>
						...
						<td style='text-align: center; vertical-align: middle;'>
							...
							<a href='index.php?mod=edit_pessoal&search=1&a=2&id=". $row->ID_FUNCIONARIO ."' class='btn btn-xs btn-warning'> 
						...
						echo"
							<a href='index.php?mod=send_pass&b=2&id=". $row->ID_FUNCIONARIO ."' class='btn btn-xs btn-danger'> 
